...
class Beam:
    ...
    def get_next_input(self):
        return Variable(self.next_beam_input, volatile=False), self.next_beam_input_list

    def get_parent_beams(self):
        return Variable(self.parent_beam_idxs, volatile=False)
    ...
    def advance(self, wordLprobas):
        ...
        prevBeam = torch.div(bestScoresId, numExpandWords, rounding_mode='floor')
    ...
    #
    def get_sampled_top_k(self, top_k):
        return heapq.nlargest(top_k, self.done_seq)

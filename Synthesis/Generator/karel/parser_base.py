...
class Parser(object):
    ...
    def random_code(self, create_hit_info=False, *args, **kwargs):
        ...
        if count_diff > 0:
            print("count_difffffffffffffffffffffffffffffffffff")
            action_candidates = []
            tokens = code.split()
    ...
    def generate_subcode(self,code):
         # split = code.split("#")
        #print(code)
       # code = code.replace( 'm) DEF run m(' , "") 
        temp = code.split()
        mid_str = "best"
        begin = ('DEF', 'run' ,'m(')
        ...
        sub_code1 = temp[:6] 
        sub_code1.append('m)')
        sub_code1 = " ".join(sub_code1)
       # print(sub_code1)
        
        sub_code2 =  temp[6:9]
        sub_code2.insert(0, 'DEF')
        sub_code2.insert(1, 'run')
        sub_code2.insert(2, 'm(')
        sub_code2.append('m)')
        sub_code2 = " ".join(sub_code2)
        
        sub_code3 =  temp[9:]
        sub_code3.insert(0, 'DEF')
        sub_code3.insert(1, 'run')
        sub_code3.insert(2, 'm(')
        sub_code3 = " ".join(sub_code3)
        
        #print(sub_code2)
        #print(sub_code3)
        return sub_code1, sub_code2, sub_code3
